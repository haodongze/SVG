...
from config.hparams_dense import *
from single_train import SVG
from single_train_dense import SVG_dense
from multi_train import MultiSVG
from single_evaluation import Evaluation
from multi_evaluation import MultiEvaluation

PARAMS_MAP = {
  "svg": SVG_BASE_PARAMS,
  "svg_dense": SVG_DENSE_PARAMS,
  "svg_multi": SVG_MULTI_PARAMS,
  }
...
def train_model(args):
  ...
  if hparams.decoder == "disc_gen" or hparams.decoder == "gen":
    print("MULTITASK LEARNING")
    model = MultiSVG(hparams)
