...
SVG_DENSE_PARAMS = defaultdict(
  ...
  img_features_h5='/share1/dzhao/mvan-visdial/data/visdial_1.0_img/features_%s_%s.h5',
  # img_feature_type | train, val, test
  ...
  load_pthpath="/share1/dzhao/SVG/svg-disc_1.0/20230417-161131/checkpoints/checkpoint_5.pth",
  ...
  num_epochs=5,
  train_batch_size=12, # 32 x num_gpus is a good rule of thumb
  eval_batch_size=12,
  ...
  initial_lr=0.002,
  lr_gamma=0.3,
  lr_milestones=[2],  # epochs when lr —> lr * lr_gamma
  # lr_gamma2=0.1,
  # lr_milestones2=[6],  # epochs when lr —> lr * lr_gamma2

  # Model related arguments
  encoder='svg',
  decoder='disc_dense',  # [disc,gen]
